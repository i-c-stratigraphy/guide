...
It may approximate time correlation, or it may be the identification of the same biofacies, which may be diachronous.
...
Named biostratigraphic units will automatically change scope to accord with changes in the scope of taxa defining or characterizing them.
A fossil name once used for a biozone is not available for use in a different zonal sense by a later author. If it is desirable to continue the use of a taxonomic term that is no longer valid, the term should be placed in quotation marks, e.g. &quot;Rotalia&quot; beccari Zone.
